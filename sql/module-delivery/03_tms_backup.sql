...
CREATE TABLE IF NOT EXISTS bzptn_detail (
  ...
  COMMENT='납품처 TMS 상세 (TMS 자체 관리 — WMS BZPTN 기본정보와 별개)';
...
-- ── 데이터 복원 시 아래 INSERT 구문에 실제 데이터 추가 ─────────
-- 예시 형식:
-- INSERT IGNORE INTO bzptn_detail
--   (PTNRKY, PTNRTY, OWNRKY, WAREKY, ROUTE_CD, AREA_CD, MAX_TON, CREDAT, LMODAT)
-- VALUES
--   ('C10001', 'CT', 'KN', 'WH01', 'R001', 'SEOUL', 5.0, '20260101', '20260101');
--
-- INSERT IGNORE INTO route_cost
--   (WAREKY, PTNRKY, CARTYPE, COST_AMT, DIST_KM, EFF_DATE, UPDDAT, UPDUSR)
-- VALUES
--   ('WH01', 'C10001', '5톤', 350000.00, 45.5, '20260101', '20260101', 'ADMIN');
